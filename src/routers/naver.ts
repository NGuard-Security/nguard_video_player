...
const supportedPlayer = ['html5', 'flowplayer', 'jwplayer', 'videojs', 'vjs-plus']

router.get(
  '/:club/:article/:index',
  function (req: Request, res: Response, next: NextFunction) {
    const clubId = isNaN(Number(req.params.club)) ? null : req.params.club
    const clubName = isNaN(Number(req.params.club)) ? req.params.club : null
